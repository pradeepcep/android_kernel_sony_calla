...
#ifdef CCI_HW_ID
#include <../mediatek/platform/mt6752/kernel/drivers/cci_hw_id/cci_hw_id.h>
...
#if CCI_KLOG_CRASH_SIZE
static const char *fault_level_str[] = { "NONE", "panic", "die/bug", "data abort", "prefetch abort", "subsys", "watchdog" };
//level: 0x10:enable/disable, 0x01: panic, 0x02: die/bug, 0x03: data abort, 0x04: prefetch abort, 0x05: subsystem fatal error, 0x06: watchdog
