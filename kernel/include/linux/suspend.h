...
//[LY28] ==> new suspend state for identifying device booting, added by Jimmy@CCI
...
//[LY28] ==> active wakeup source, added by Jimmy@CCI
#ifdef CONFIG_CCI_PM_WAKEUP_LOG
extern void print_active_wakeup_source(void);
