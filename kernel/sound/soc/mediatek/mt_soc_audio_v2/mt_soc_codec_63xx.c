...
// BAM_S 20141107 for ftm earphone loopback single channel
static int Audio_AmpL_Set_Ftm(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
    ...
    {
    	// disable headsetL, enable headsetR
		mCodec_data->mAudio_Ana_DevicePower[AUDIO_ANALOG_DEVICE_OUT_HEADSETL] = ucontrol->value.integer.value[0];
        Ana_Set_Reg(AUDDEC_ANA_CON0, 0xF44F, 0xffff);
    }	
...
static int Audio_AmpR_Set_Ftm(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
    ...
    {
    	// disable headsetR, enable headsetL
		mCodec_data->mAudio_Ana_DevicePower[AUDIO_ANALOG_DEVICE_OUT_HEADSETR] = ucontrol->value.integer.value[0];
        Ana_Set_Reg(AUDDEC_ANA_CON0, 0xF42F, 0xffff);
    }	
...
static void Headset_Speaker_Amp_Change(bool enable)
{
    if (enable)
    {
        ...
        {
            TurnOnDacPower();
//BAM_S 20141219 DMS06119024
			Ana_Set_Reg(AFUNC_AUD_CON0, 0xC7A1, 0xffff);			
//BAM_E			
        }
...
static const struct snd_kcontrol_new mt6331_snd_controls[] =
{
    ...
    // BAM_S 20141107 for ftm earphone loopback single channel
	SOC_ENUM_EXT("Audio_Earphone_R_Switch_Ftm", Audio_DL_Enum[12], Audio_AmpR_Get, Audio_AmpR_Set_Ftm),  //\u6dfb\u52a0\u8fd92\u884c
    SOC_ENUM_EXT("Audio_Earphone_L_Switch_Ftm", Audio_DL_Enum[13], Audio_AmpL_Get, Audio_AmpL_Set_Ftm),
	// BAM_E
