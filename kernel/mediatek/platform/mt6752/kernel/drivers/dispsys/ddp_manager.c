...
void dpmgr_path_dsi_off(disp_path_handle dp_handle, void * cmdq_handle,unsigned int level) //Taylor--20150108
{
...
void dpmgr_path_idle_off(disp_path_handle dp_handle, void * cmdq_handle,unsigned int level) //Taylor--20150108
{
    int i=0;
    int module_name ;
    ASSERT(dp_handle != NULL);
