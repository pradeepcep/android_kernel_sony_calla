...
//CEI comments start//
extern int BQ24158_set_bat_charging_current_limit(int current_limit);
//CEI comments end//
#endif
...
//CEI comments start//
    if(isInternalCharger)
      ...
      BQ24158_set_bat_charging_current_limit(-1);
//CEI comments end//
...
//CEI comments start//
    if(isInternalCharger)
      ...
      BQ24158_set_bat_charging_current_limit(cl_bcct_cur_limit);
//CEI comments end//
...
static int __init mtk_cooler_bcct_init(void)
{
  ...
  mtk_cooler_bcct_dprintk("[mtk_cooler_bcct_init] isInternalCharger=%d\n", isInternalCharger);
