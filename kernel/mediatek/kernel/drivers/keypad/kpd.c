...
/*Aaron [S]-Long pressed pwr key to ramdump*/
#ifdef CONFIG_CCI_FORCE_RAMDUMP
static void qpnp_pon_force_ramdump(void);
unsigned long pwrkey_pressed = 0;
#endif
/*Aaron [E]*/
...
void kpd_pwrkey_pmic_handler(unsigned long pressed)
{
	...
	/*Aaron [S]-Long pressed pwr key to ramdump*/
	#ifdef CONFIG_CCI_FORCE_RAMDUMP
		pwrkey_pressed = pressed;
		qpnp_pon_force_ramdump();
	#endif
	/*Aaron [E]*/
