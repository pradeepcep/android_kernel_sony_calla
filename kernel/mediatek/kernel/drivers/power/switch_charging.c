...
//CEI comments end//
 ...
 // ============================================================ //
//CEI comments start//
void BQ24158_BATTERY_SetUSBState(int usb_state_value)
//CEI comments end//
{
#if defined(CONFIG_POWER_EXT)
//CEI comments start//
	battery_xlog_printk(BAT_LOG_CRTI, "[BQ24158_BATTERY_SetUSBState] in FPGA/EVB, no service\r\n");
//CEI comments end//
#else
...
//CEI comments start//
kal_uint32 BQ24158_get_charging_setting_current() //return ibat
//CEI comments end//
{
...
//CEI comments end//
    ...
    {
//CEI comments start//
        cv_voltage = BATTERY_VOLT_03_900000_V;
//CEI comments end//
    }
...
//CEI comments start//
PMU_STATUS BQ24158_do_jeita_state_machine(void) //return PMU_STATUS_OK->means set CV after temperature changed, others->don't set CV
//CEI comments end//
{
	BATTERY_VOLTAGE_ENUM cv_voltage;
...
//CEI comments start//
static void set_jeita_charging_current(void) //set g_temp_CC_value & g_temp_input_CC_value based on g_temp_status & BMT_status.charger_type
{
#ifdef CONFIG_USB_IF
	if(BMT_status.charger_type == STANDARD_HOST)
		return;
	...
	else if((g_temp_status == TEMP_POS_45_TO_POS_60) && (BMT_status.charger_type == STANDARD_CHARGER))
    {
        g_temp_CC_value = CHARGE_CURRENT_775_00_MA; //for lower/higher temp
        battery_xlog_printk(BAT_LOG_CRTI, "[BATTERY] JEITA set charging current : %d(%d)\r\n", g_temp_CC_value, g_temp_status);
    }
}
//CEI comments end//
...
//CEI comments start//
bool BQ24158_get_usb_current_unlimited(void) //YF
//CEI comments end//
{
...
//CEI comments start//
void BQ24158_set_usb_current_unlimited(bool enable) //set usb_unlimited from current_cmd_write()
//CEI comments end//
{
...
//CEI comments start//
kal_uint32 BQ24158_set_bat_charging_current_limit(int current_limit) //return 1 & set g_temp_CC_value if (current_limit != -1), return 0 if (current_limit == -1)
//CEI comments end//
{
//CEI comments start//
    battery_xlog_printk(BAT_LOG_CRTI, "[BATTERY] BQ24158_set_bat_charging_current_limit (%d)\r\n", current_limit);
//CEI comments end//
...
//CEI comments start//
static void select_charging_curret(void) //set g_temp_CC_value & g_temp_input_CC_value based on g_temp_status & BMT_status.charger_type
//CEI comments end//
{
...
//CEI comments start//
        if (BQ24158_get_usb_current_unlimited()) {
//CEI comments end//
            g_temp_input_CC_value = AC_CHARGER_CURRENT;
            g_temp_CC_value = AC_CHARGER_CURRENT;
...
//CEI comments start//
void BQ24158_mt_battery_charging_algorithm()
//CEI comments end//
{
