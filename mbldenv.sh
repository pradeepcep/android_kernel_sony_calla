...
PATH=/usr/lib/jvm/java-6-oracle/bin:$PWD/prebuilts/gcc/linux-x86/arm/cit-arm-linux-androideabi-4.8/bin:$PWD/prebuilts/gcc/linux-x86/arm/arm-eabi-4.7/bin:$PWD/prebuilts/gcc/linux-x86/aarch64/linaro-aarch64-linux-gnu-4.8/bin:$PWD/prebuilts/misc/linux-x86/make:$PATH
export PATH
