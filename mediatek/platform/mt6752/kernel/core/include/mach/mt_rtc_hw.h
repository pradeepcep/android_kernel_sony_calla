...
#if defined(CONFIG_SONY_S1_SUPPORT) || defined(SONY_S1_SUPPORT)
#define RTC_SPAR0_S1_SERVICE		(1U << 15)
#define RTC_SPAR0_FOTA			(1U << 14)
#endif // #if defined(CONFIG_SONY_S1_SUPPORT) || defined(SONY_S1_SUPPORT)
//CEI comments end//
