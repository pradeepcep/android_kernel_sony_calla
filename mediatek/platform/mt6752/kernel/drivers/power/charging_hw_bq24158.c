...
//CEI comments start//
//kal_bool charging_type_det_done = KAL_TRUE; //ORG
extern kal_bool charging_type_det_done; //use this variable in charging_hw_pmic.c
//CEI comments end//
...
//CEI comments end//
 ...
 static kal_uint32 charging_set_cv_voltage(void *data)
 {
    ...
    else
    {
        if(is_mt6311_exist())
        {
            ...
            {
				battery_xlog_printk(BAT_LOG_CRTI, "[charging_set_cv_voltage] mt6311_exist CV=%d\r\n", cv_value);
				bq24158_set_oreg(register_value); 
            }
        }
        else
        {
            battery_xlog_printk(BAT_LOG_CRTI, "[charging_set_cv_voltage] mt6311_dont_exist CV=%d\r\n", cv_value);
            bq24158_set_oreg(register_value);
        } 
    }  
    #endif
 ...
 static kal_uint32 charging_set_current(void *data)
 {
	...
	battery_xlog_printk(BAT_LOG_CRTI, "[charging_set_current] ibat=%d\r\n", current_value);
 ...
 static kal_uint32 charging_set_input_current(void *data)
 {
	...
	battery_xlog_printk(BAT_LOG_CRTI, "[charging_set_input_current] iusb=%d\r\n", (*(kal_uint32 *)data));
 ...
 static kal_uint32 charging_reset_watch_dog_timer(void *data)
 {
  ...
  static kal_uint32 charging_set_hv_threshold(void *data)
  {
	 ...
	 battery_xlog_printk(BAT_LOG_CRTI, "[charging_set_hv_threshold] VCDT=%d\r\n", voltage);
...
//CEI comments start//
#if 0 //use this function in charging_hw_pmic.c
 ...
 */
//CEI comments start//
kal_int32 BQ24158_chr_control_interface(CHARGING_CTRL_CMD cmd, void *data)
//CEI comments end//
 {
	 kal_int32 status;
