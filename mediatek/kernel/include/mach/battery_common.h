...
#define PC_MAX_CHARGING_TIME             24*60*60 	// 24hr for PC charger
//CEI comments start//
...
//CEI comments start//
// Change it based on battery spec
...
#define TEMP_POS_45_THRES_MINUS_X_DEGREE 36
//CEI comments end//
...
#define TEMP_POS_10_THRES_PLUS_X_DEGREE 19
//CEI comments end//
...
#define TEMP_POS_0_THRES_PLUS_X_DEGREE 9
//CEI comments end//
...
#else
//CEI comments start//
// #define TEMP_NEG_10_THRESHOLD  0				//MTK-ORG
// #define TEMP_NEG_10_THRES_PLUS_X_DEGREE  0	//MTK-ORG
// HW-Lee. NickJS hope
...
typedef struct 
{
	kal_bool			bat_exist;
	kal_bool			bat_full;  
	INT32			bat_charging_state; //stores CHR_PRE, CHR_CC, CHR_TOP_OFF, CHR_POST_FULL, CHR_BATFULL, CHR_ERROR, CHR_HOLD
	UINT32			bat_vol; //in mV
	kal_bool			bat_in_recharging_state;	
	kal_uint32		Vsense;
	kal_bool			charger_exist;   
	UINT32			charger_vol; //in mV
	INT32			charger_protect_status; 
	INT32			ICharging; //in mA
	INT32			IBattery;
	INT32			temperature; //in degC
	INT32			temperatureR;
	INT32			temperatureV;
	UINT32			total_charging_time; //in sec
...
//CEI comments start//
extern kal_uint32 BQ24158_get_charging_setting_current(void);
//CEI comments end//
...
//CEI comments start//
extern void BQ24158_set_usb_current_unlimited(bool enable);
//CEI comments end//
extern bool get_usb_current_unlimited(void);
//CEI comments start//
extern bool BQ24158_get_usb_current_unlimited(void);
//CEI comments end//
...
//CEI comments start//
extern void BQ24158_mt_battery_charging_algorithm(void);
//CEI comments end//
#if defined(MTK_JEITA_STANDARD_SUPPORT)
extern PMU_STATUS do_jeita_state_machine(void);
//CEI comments start//
extern PMU_STATUS BQ24158_do_jeita_state_machine(void);
//CEI comments end//
#endif
