...
PRODUCT_COPY_FILES += $(MTK_ROOT_CONFIG_OUT)/mtk-kpd.kl:system/usr/keylayout/mtk-kpd.kl \
                      ...
                      $(MTK_ROOT_CONFIG_OUT)/media_profiles.xml:system/etc/media_profiles.xml \
                      ...
                      $(MTK_ROOT_CONFIG_OUT)/files/multi-cdf-symlinker.sh:system/bin/multi-cdf-symlinker.sh \
...
# cci LY28 TP selftest start
PRODUCT_COPY_FILES += $(MTK_ROOT_CUSTOM_OUT)/kernel/touchpanel/disc_para:system/bin/disc_para \
                      $(MTK_ROOT_CUSTOM_OUT)/kernel/touchpanel/openshort_para:system/bin/openshort_para \
                      $(MTK_ROOT_CUSTOM_OUT)/kernel/touchpanel/disc_para_hh:system/bin/disc_para_hh \
                      $(MTK_ROOT_CUSTOM_OUT)/kernel/touchpanel/openshort_para_hh:system/bin/openshort_para_hh
# cci LY28 TP selftest end

#[LY28] ==> add dalvik symbol file, requested by J68, added by Jimmy@CCI
PRODUCT_COPY_FILES += $(MTK_ROOT_CONFIG)/$(ARCH_MTK_PLATFORM)/symbols/libdvm.so:symbols/system/lib/libdvm.so
#[LY28] <== add dalvik symbol file, requested by J68, added by Jimmy@CCI
