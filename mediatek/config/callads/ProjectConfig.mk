...
#CEI Vince change
CUSTOM_HAL_IMGSENSOR = ov5670_mipi_raw ov5670_chicony_mipi_raw imx134_mipi_raw ov2680_mipi_raw ov2680_chicony_mipi_raw
#CEI Vince change

#CEI
CUSTOM_KERNEL_STAMINA = SOMC_XSSM

# = CUSTOM_HAL_MAIN_LENS +CUSTOM_HAL_MAIN_BACKUP_LENS + CUSTOM_HAL_SUB_LENS + CUSTOM_HAL_SUB_BACKUP_LENS
CUSTOM_HAL_LENS = dw9714af gt9762af dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR = 

#CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR = imx134_mipi_raw

# lens driver config for main camera (2nd solution)
#CEI Vince change
CUSTOM_HAL_MAIN_BACKUP_LENS = gt9762af
#ruo
...
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR=ov5670_chicony_mipi_raw
...
CUSTOM_HAL_SUB_BACKUP_IMGSENSOR = ov2680_chicony_mipi_raw
...
CUSTOM_KERNEL_CAM_CAL = ov5670otp
...
CUSTOM_KERNEL_FLASHLIGHT = sky81290_flashlight
...
#CEI Vince change
CUSTOM_KERNEL_IMGSENSOR = ov5670_mipi_raw ov5670_chicony_mipi_raw imx134_mipi_raw ov2680_mipi_raw ov2680_chicony_mipi_raw
...
#CEI Vince change
CUSTOM_KERNEL_LENS = dw9714af gt9762af dummy_lens
#ruo
...
#CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR = imx134_mipi_raw

# lens driver config for main camera (2nd solution)
CUSTOM_KERNEL_MAIN_BACKUP_LENS = gt9762af
...
# Kernel space image sensor  driver:Main camera (rear camera) used backup sensor driver.Value is used main backup sensor name.
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR = ov5670_chicony_mipi_raw
...
CUSTOM_KERNEL_SUB_BACKUP_IMGSENSOR = ov2680_chicony_mipi_raw
...
CUSTOM_KERNEL_TOUCHPANEL = ektf2k S3202
...
CUSTOM_LK_LCM = hx8389b_qhd_dsi_vdo_truely hx8389c_qhd_dsi_vdo_truely hx8389c_2nd_qhd_dsi_vdo_truely
...
#CUSTOM_MODEM = mt6752k52_md1_lwg_dsds
#CUSTOM_MODEM = mt6752k52_md1_lwg_cei_gina
CUSTOM_MODEM = mt6752k52_md1_lwg_cei_gina_ds
...
CUSTOM_KERNEL_LCM = hx8389b_qhd_dsi_vdo_truely hx8389c_qhd_dsi_vdo_truely hx8389c_2nd_qhd_dsi_vdo_truely

# To choose uboot LCM driver name
#ruo
# CUSTOM_UBOOT_LCM = nt35582_mcu_6575
# CUSTOM_UBOOT_LCM = hx8389b_qhd_dsi_vdo_truely
...
#CREATE_PROJECT_INFO=20141001202726
MTK_BUILD_VERNO = ALPS.KK2.MP13.TC9SP.V1

# SONY S1 support (replaces MTK security in bootstages and adds legacy SONY behaviour to the bootstages (indicators and configurations)
SONY_S1_SUPPORT=yes

#Enable SoMC_Feature_15017
