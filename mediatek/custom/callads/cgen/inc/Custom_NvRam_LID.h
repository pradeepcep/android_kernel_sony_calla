...
//    AP_CFG_CUSTOM_FILE_CUSTOM2_LID,
    ...
    //CEI comments start //
    //LE:A Add NVRAM
    AP_CFG_CUSTEOM_FILE_SW_VER_LID,
    AP_CFG_CUSTEOM_FILE_PROJ_ID_LID,
    //CEI comments end //	
	AP_CFG_CUSTOM_FILE_P_SENSOR_THRESHOLD_LID,
...
/* verno of data items */
/* audio file version */
#define AP_CFG_RDCL_FILE_AUDIO_LID_VERNO			audio_par_version

/* GPS file version */
#define AP_CFG_CUSTOM_FILE_GPS_LID_VERNO			"000"

/* audio acf file version */
#define AP_CFG_RDCL_FILE_AUDIO_COMPFLT_LID_VERNO	audio_par_version

/* audio hcf file version */
#define AP_CFG_RDCL_FILE_HEADPHONE_COMPFLT_LID_VERNO	audio_par_version
...
#define AP_CFG_RDCL_FILE_AUDIO_PARAM_MED_LID_VERNO  audio_par_version

/* audio volume custom file version */
#define AP_CFG_RDCL_FILE_AUDIO_VOLUME_CUSTOM_LID_VERNO  audio_par_version
#define AP_CFG_RDCL_FILE_AUDIO_VER1_VOLUME_CUSTOM_LID_VERNO  audio_par_version

/* dual mic custom file version */
#define AP_CFG_RDCL_FILE_DUAL_MIC_CUSTOM_LID_VERNO  audio_par_version

/* audio wb specch param custom file version */
#define AP_CFG_RDCL_FILE_AUDIO_WB_PARAM_LID_VERNO audio_par_version
...
#define AP_CFG_RDCL_FILE_AUDIO_MUSIC_DRC_LID_VERNO			audio_par_version
#define AP_CFG_RDCL_FILE_AUDIO_RINGTONE_DRC_LID_VERNO			audio_par_version

#define AP_CFG_RDCL_FILE_AUDIO_MAGI_CONFERENCE_LID_VERNO			"000"
#define AP_CFG_RDCL_FILE_AUDIO_HAC_PARAM_LID_VERNO			"000"
//CEI comments start //
//LE:A Add NVRAM
#define AP_CFG_CUSTEOM_FILE_SW_VER_LID_VERNO			"000"
#define  AP_CFG_CUSTEOM_FILE_PROJ_ID_LID_VERNO			"000"
//CEI comments end //
#define AP_CFG_CUSTOM_FILE_P_SENSOR_THRESHOLD_LID_VERNO			"000"
