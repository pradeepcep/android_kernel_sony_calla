/*Adding “Copyright (C) 2014 Sony Mobile Communications AB.”*/
...
#endif
#if defined(GT9762AF)
extern PFUNC_GETLENSDEFAULT pGT9762AF_getDefaultData;
#endif
// CEI comments end //
...
// CEI comments start //
    ...
    #endif
	#if defined(GT9762AF)
        {OV5670_CHICONY_MIPI_SENSOR_ID, GT9762AF_LENS_ID, "GT9762AF", pGT9762AF_getDefaultData},		//[Compal] Add it for Second sensor
    #endif
    #if defined(BU6429AF)
        {IMX134_SENSOR_ID, BU6429AF_LENS_ID, "BU6429AF", pBU6429AF_getDefaultData},
    #endif
//    #if defined(DW9714AF)
