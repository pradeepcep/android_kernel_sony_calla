...
//CEI comments start //
//LE:A Add NVRAM
LID_BIT VER_LID(AP_CFG_CUSTEOM_FILE_SW_VER_LID)
FILE_SW_VER_STRUCT *CFG_FILE_SW_VER_REC_TOTAL
{

};

LID_BIT VER_LID(AP_CFG_CUSTEOM_FILE_PROJ_ID_LID)
FILE_PROJ_ID_STRUCT *CFG_FILE_PROJ_ID_REC_TOTAL
{

};
//CEI comments end //

LID_BIT VER_LID(AP_CFG_CUSTOM_FILE_P_SENSOR_THRESHOLD_LID)
FILE_P_SENSOR_THRESHOLD_STRUCT *CFG_FILE_P_SENSOR_THRESHOLD_REC_TOTAL
{
