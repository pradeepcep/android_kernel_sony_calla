...
extern "C"
{
    ...
    const TCFG_FILE g_akCFG_File_Custom[]=
    {
        ...
        //CEI comments start //
        //LE:A Add NVRAM
        { "/data/nvram/APCFG/APRDCL/Sw_Ver",   VER(AP_CFG_CUSTEOM_FILE_SW_VER_LID), CFG_FILE_SW_VER_REC_SIZE,
            CFG_FILE_SW_VER_REC_TOTAL, SIGNLE_DEFUALT_REC  ,    (char *)&sw_ver_default, DataReset , NULL
        },
        { "/data/nvram/APCFG/APRDCL/Proj_Id",   VER(AP_CFG_CUSTEOM_FILE_PROJ_ID_LID), CFG_FILE_PROJ_ID_REC_SIZE,
            CFG_FILE_PROJ_ID_REC_TOTAL, SIGNLE_DEFUALT_REC  ,    (char *)&proj_id_default, DataReset , NULL
        },        
        //CEI comments end //

        { "/data/nvram/APCFG/APRDCL/P_Sensor_Threshold",   VER(AP_CFG_CUSTOM_FILE_P_SENSOR_THRESHOLD_LID), CFG_FILE_P_SENSOR_THRESHOLD_REC_SIZE,
            CFG_FILE_P_SENSOR_THRESHOLD_REC_TOTAL, SIGNLE_DEFUALT_REC  ,    (char *)&p_sensor_threshold_default, DataReset , NULL
        },
    };
