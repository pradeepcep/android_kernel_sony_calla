...
#define MSDC_SDIO_FLAG    (MSDC_EXT_SDIO_IRQ | MSDC_HIGHSPEED | MSDC_UHS1)
    ...
    struct msdc_ett_settings msdc0_ett_settings[] = {
        ...
        { MSDC_HS400_MODE, 0x188, (0x1f<< 2), 0xc /*0x7*/ }, //EMMC50_PAD_DS_TUNE[MSDC_EMMC50_PAD_DS_TUNE_DLY1]
        ...
        { MSDC_HS400_MODE, 0xec,  (0x1f<<22), 0xd /*0x3*/ }, //PAD_TUNE[MSDC_PAD_TUNE_CMDRRDLY]
