...
#define CAMERA_POWER_VCAM_D2		CAMERA_POWER_VCAM_IO
#define CAMERA_POWER_VCAM_A2		CAMERA_POWER_VCAM_AF 
#define	CAMERA_POWER_VCAM_VGP3		MT6325_POWER_LDO_VGP3
...
#define CAMERA_CMRST_PIN           (GPIO117 | 0x80000000)   
