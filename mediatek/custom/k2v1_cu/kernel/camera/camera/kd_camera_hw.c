...
/////////////  134/////////////
	...
	if(currSensorName && (0 == strcmp(SENSOR_DRVNAME_IMX134_MIPI_RAW, currSensorName)))
	{	
		//VCAM_IO
...
/////////  ov2680 ///////////
	...
	{
		//VCAM_IO
		PK_DBG("[CAMERA SENSOR] ov2680 enable digital power\n");
        if(TRUE != hwPowerOn(CAMERA_POWER_VCAM_D2, VOL_1800,mode_name))
        {
            PK_DBG("[CAMERA SENSOR] Fail to enable digital power\n");
            goto _kdCISModulePowerOn_exit_;
		...
		//vgp3
		if(TRUE != hwPowerOn(CAMERA_POWER_VCAM_VGP3, VOL_1800,mode_name))
				{
					PK_DBG("[CAMERA SENSOR] Fail to enable digital power\n");
					goto _kdCISModulePowerOn_exit_;
				}
...
///////////////////
    ...
    {           
        ...
        if(TRUE != hwPowerDown(CAMERA_POWER_VCAM_VGP3,mode_name))
        {
             PK_DBG("[CAMERA SENSOR] Fail to OFF core power(%d)\n",CAMERA_POWER_VCAM_D);
             goto _kdCISModulePowerOn_exit_;
        }
