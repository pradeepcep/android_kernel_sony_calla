...
#define I2C_REGISTER_ID            0x18<<1 //avoid same ID register
// CEI comments start //
...
inline static int getAFInfo(__user stGT9762AF_MotorInfo * pstMotorInfo)
{
...
#ifdef LensdrvCM3
inline static int getAFMETA(__user stGT9762AF_MotorMETAInfo * pstMotorMETAInfo)
{
