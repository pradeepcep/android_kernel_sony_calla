...
#define GT9762AFIOC_T_MOVETO _IOW(GT9762AF_MAGIC,1,unsigned long)

#define GT9762AFIOC_T_SETINFPOS _IOW(GT9762AF_MAGIC,2,unsigned long)

#define GT9762AFIOC_T_SETMACROPOS _IOW(GT9762AF_MAGIC,3,unsigned long)
#ifdef LensdrvCM3
