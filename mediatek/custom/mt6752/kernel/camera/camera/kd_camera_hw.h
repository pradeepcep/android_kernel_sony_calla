...
// CEI comments start //
//Modify for camera reset pin
//#define CAMERA_CMRST_PIN           (GPIO117 | 0x80000000) //PDP1 IMX134 XCLR
#define CAMERA_CMRST_PIN           (GPIO75 | 0x80000000) //PDP2 VCM PD
...
typedef enum{
	...
	// CEI comments start //
	SUBVDD= SUB_CAMERA_POWER_VCAM_D
	// CEI comments end //
}PowerType;
