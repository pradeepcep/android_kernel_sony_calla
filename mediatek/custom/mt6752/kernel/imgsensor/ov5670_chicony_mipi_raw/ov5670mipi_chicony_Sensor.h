 ...
 *
 ****************************************************************************/
#ifndef _OV5670MIPI_CHICONY_SENSOR_H			//[Compal] Add it for Second sensor
#define _OV5670MIPI_CHICONY_SENSOR_H			//[Compal] Add it for Second sensor
...
typedef struct otp_struct{
		int flag;//bit[7]: no use, bit[6]:wb
		int module_integrator_id;			//[Compal] Add it for Second sensor
		//int lens_id;
		//int production_year;
...
#define BG_ratio_Typical 290
#define AWB_RG_MSB_OFFSET 4
#define AWB_BG_MSB_OFFSET 5
#define AWB_LSB_OFFSET 6
#define MID_OFFSET	3					//[Compal] Add it for Second sensor
