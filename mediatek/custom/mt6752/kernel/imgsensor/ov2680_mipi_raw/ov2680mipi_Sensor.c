...
static imgsensor_info_struct imgsensor_info = { 
	.sensor_id = OV2680MIPI_SENSOR_ID,  /*sensor_id = 0x2680*/ //record sensor id defined in Kd_imgsensor.h
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id) 
{
	...
	if (mt_get_gpio_in(CAMERA_CMSOURCE_PIN) != 1) 
	{
		// if Sensor gpio is not correct, Must set *sensor_id to 0xFFFFFFFF
		LOG_INF("ov2680 F_CAM_ID = 0, it is ov2680 second source");
		*sensor_id = 0xFFFFFFFF;
		return ERROR_SENSOR_CONNECT_FAIL;
	}									//[Compal] Add it for Second sensor
	LOG_INF("roger_ov2680_CAMERA_CMSOURCE_PIN_OK");
	return ERROR_NONE;
}
