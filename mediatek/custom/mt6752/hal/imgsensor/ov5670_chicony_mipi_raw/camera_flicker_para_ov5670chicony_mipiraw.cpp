...
#include "camera_AE_PLineTable_ov5670chicony_mipiraw.h"		//[Compal] Add it for Second sensor
#include "camera_info_ov5670chicony_mipiraw.h"				//[Compal] Add it for Second sensor
