...
//COMMON
#define AF_DAC_DATA_SHIFT_INIFITE 45			//RogerMa@20141122
#define AF_DAC_DATA_SHIFT_MACRO 25			    //RogerMa@20141122
...
UINT32 DoCamCal2AGain(INT32 CamcamFID, UINT32 start_addr, UINT32 BlockSize, UINT32* pGetSensorCalData)
{
	...
	//Structure
	/*
	Byte[0]: AWB R/G MSB, Bit[7:0] : AWB R/G ratio[9:2]
	Byte[1]: AWB B/G MSB, Bit[7:0] : AWB B/G ratio[9:2]
	Byte[2]: AWB LSB, Bit[1:0] : AWB B/G ratio[1:0], Bit[3:2] : AWB R/G ratio[1:0]
	Byte[3]: AF-Infinite, Bit[1:0] : AF DAC[9:8]
	Byte[4]: AF-Infinite, Bit[7:0] : AF DAC[7:0]
	Byte[5]: AF-Macro, Bit[1:0] : AF DAC[9:8]
	Byte[6]: AF-Macro, Bit[7:0] : AF DAC[7:0]
	*/
    if(pCamCalData->DataVer >= CAM_CAL_N3D_DATA)
    {
        err = CAM_CAL_ERR_NO_DEVICE;
    ...
    { 
		...
		//memset(pCamCalData->Single2A.S2aAf,0x0,sizeof(pCamCalData->Single2A.S2aAf));
	        ...
	        //Byte[5]: AF-Macro, Bit[1:0] : AF DAC[9:8]
	        //Byte[6]: AF-Macro, Bit[7:0] : AF DAC[7:0]
                cam_calCfg.u4Offset = start_addr+3;
                cam_calCfg.u4Length = 4;
                ...
                pCamCalData->Single2A.S2aAf[0] -= AF_DAC_DATA_SHIFT_INIFITE;			//45//RogerMa@20141122
                pCamCalData->Single2A.S2aAf[1] -= AF_DAC_DATA_SHIFT_MACRO;				//25//RogerMa@20141122
