...
#include INCLUDE_FILENAME_ISP_REGS_PARAM
    ...
    ISPMulitCCM:{
      Poly22:{
        ...
        798,      // i4B_MIN
        {  // i4P00[9]
            9777500, -4630000, -30000, -1760000, 7830000, -947500, -487500, -4252500, 9862500
        },
        {  // i4P10[9]
            3019791, -3258190, 213803, -76738, -415583, 454191, 249726, 308926, -584517
        },
        {  // i4P01[9]
            2703225, -2734532, 11555, -358927, -440397, 770273, -33733, -1153210, 1164991
        },
        {  // i4P20[9]
            0, 0, 0, 0, 0, 0, 0, 0, 0
        },
    ...
    {
        {
            ...
            // PWB light area
            {
                ...
                // Cloudy daylight
                {
                    299,    // PCloudyRightBound
                    124,    // PCloudyLeftBound
                    -282,    // PCloudyUpperBound
                    -375    // PCloudyLowerBound
                },
                // Shade
                {
                    399,    // PShadeRightBound
                    124,    // PShadeLeftBound
                    -282,    // PShadeUpperBound
                    -375    // PShadeLowerBound
                },
                // Twilight
                {
                    -18,    // PTwiRightBound
