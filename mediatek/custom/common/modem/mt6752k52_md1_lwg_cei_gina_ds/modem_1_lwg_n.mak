# Generated at 2014-10-01 20:13:37

TAS_SUPPORT = FALSE     # Description:
                        # Option Values:
                        # TRUE: Support TAS
...
MTK_INTERNAL_NVRAM_VISIBLE = FALSE     # Description:
                                       # This option is used for mtk internal nvram  visible control (Switch by RD only)
                                       # Option Values:
                                       # TRUE: Internal NVRAM Items are visible (MTK RD only)
                                       # FALSE: Internal NVRAM Items are not visible (default value)
                                       # Switch-ability:
                                       # Non-switchable
...
# ------------------------------ Verno information
VERNO = MOLY.LR9.W1423.MD.LWTG.MP.V13.P37-2.41.J.1.025
BUILD = BUILD_NO
...
PROJECT_MAKEFILE_EXT = CCI6752_LW_KK_MD1(LWG)_EXT
...
#[MTK internal used]# ------------------------------ 
ORIGINAL_VERNO = MOLY.LR9.W1423.MD.LWTG.MP.V13.P37
...
ORIGINAL_PROJECT_NAME = CCI6752_LW_KK_MD1
...
CUSTOM_OPTION += __SATCC__ __SATCE__ __DISABLE_DISPLAY_ROAMING_HPLMN_IN_EPLMN__

CUSTOM_OPTION += __BT_SIM_PROFILE__

CUSTOM_OPTION += __CP_HW_CIPHER_ENABLE__ __PLMN_SEARCH_ABORT_SUPPORT__
...
CUSTOM_OPTION += __ACMT_SUPPORT__  

CUSTOM_OPTION += __SUPPORT_APN_USER_NAME_PASSWORD_LEN_32__

CUSTOM_OPTION += __DISABLE_FIRST_SEARCH_4G_AFTER_PS_OOS__

CUSTOM_OPTION += __DISABLE_FIRST_SEARCH_3G_AFTER_PS_OOS__

REMOVE_CUSTOM_OPTION += __ALLOW_SIM_REFRESH_RESET_WHEN_IN_CALL__
...
-include sony/ta/mtk/make/trimarea.mak	
-include make/s1sl.mak
