...
static void lcm_get_params(LCM_PARAMS *params)
{
		...
		params->dsi.vertical_frontporch					= 5; //12; // 1  12
		params->dsi.vertical_active_line				= FRAME_HEIGHT; 

		params->dsi.horizontal_sync_active				= 10; //0x16;// 50  2
		params->dsi.horizontal_backporch				= 60;  //0x38;
...
static void lcm_init(void)
{
...
#ifdef BUILD_LK
			  printf("[LK]------LCM hx8389b000----%s------\n",__func__);
    #else
			  printk("[KERNEL]------LCM hx8389b000----%s------\n",__func__);
    #endif

	/***
		//printk("=== lcm hx8389b init ===");
	...
	**/
    ...
    MDELAY(10);//Must over 6 ms,SPEC request
	...
	#ifdef BUILD_LK
		  printf("[LK]------LCM hx8389b----%s------\n",__func__);
    #else
		  printk("[KERNEL]------LCM hx8389b----%s------\n",__func__);
    #endif
...
#ifdef BUILD_LK
			  printf("[LK]=== lcm hx8389b init set cmd1 ===\n",__func__);
    #else
			  printk("[KERNEL]=== lcm hx8389b init set cmd1 ===\n",__func__);
    #endif
	

		data_array[0] = 0x00143902;
		data_array[1] = 0x040000B1;
		data_array[2] = 0x1110E0E3;
...
#ifdef BUILD_LK
					  printf("[LK]=== === lcm hx8389b init set cmd2 ===\n",__func__);
    #else
					  printk("[KERNEL]=== lcm hx8389b init set cmd2 ===\n",__func__);
    #endif
		...
		data_array[1] = 0x120E05E0;
		data_array[2] = 0x1B3F332D;
		data_array[3] = 0x0E0B043C;
		data_array[4] = 0x12101311;
		data_array[5] = 0x0E051C1A;
		data_array[6] = 0x3F332D12;
		data_array[7] = 0x0B043C1B;
		...
		data_array[1] = 0x383C40CA;
		data_array[2] = 0x2D323334;
		data_array[3] = 0x00002027;
...
#ifdef BUILD_LK
							  printf("[LK]=== === lcm hx8389b init set done ===\n",__func__);
    #else
							  printk("[KERNEL]=== lcm hx8389b init set done ===\n",__func__);
    #endif
		//CABC
...
LCM_DRIVER hx8389b_qhd_dsi_vdo_truely_drv =
{
    .name			= "hx8389b_qhd_dsi_vdo_truely",
