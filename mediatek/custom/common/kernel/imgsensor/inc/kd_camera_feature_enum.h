...
//Add for SOMC manual scene value
FID_TO_TYPE_ENUM  (
    FID_SONY_SCENE_MODE, 
    FTYPE_ENUM  (
        SONY_SCENE_MODE_OFF    =	20,
		SONY_SCENE_MODE_PORTRAIT,
		SONY_SCENE_MODE_LANDSCAPE,
		SONY_SCENE_MODE_NIGHTSCENE,
		SONY_SCENE_MODE_NIGHTPORTRAIT,
		SONY_SCENE_MODE_BEACH,
		SONY_SCENE_MODE_SNOW,
		SONY_SCENE_MODE_SPORTS,
		SONY_SCENE_MODE_PARTY,
		SONY_SCENE_MODE_DOCUMENT,
		SONY_SCENE_MODE_BACKLIGHT_PORTRAIT,		//30
		SONY_SCENE_MODE_PET,
		SONY_SCENE_MODE_DISH,
		SONY_SCENE_MODE_SOFT_SKIN,
		SONY_SCENE_MODE_ANTI_MOTION_BLUR,
		SONY_SCENE_MODE_HANDHELD_TWILIGHT,
		SONY_SCENE_MODE_HIGH_SENSITIVITY,
		SONY_SCENE_MODE_FIREWORKS,
	    SONY_SCENE_MODE_NUM		//total manual scene number+20
    )
) SONY_SCENE_MODE_T;

//Add for SOMC IS mode S
FID_TO_TYPE_ENUM  (
    FID_SONY_IS, 
    FTYPE_ENUM  (
        SONY_IS_OFF               = 0, 
        SONY_IS_ON,							// SONY IS ON
        SONY_IS_ON_STILL_HDR,               // SONY IS HDR
        SONY_IS_AUTO,                       // SONY IS AUTO
        SONYIS_MODE_NUM
    )
) SONY_IS_MODE_T;
//Add for SOMC IS mode E
